...
function Player:create(map)
    ...
    this.behaviors = {
        ...
        -- TODO: define a new state, 'walking', which takes in keyboard input and
        -- updates dx accordingly, but also switching to 'idle' state and animation
        -- when no directions are being pressed
        -- HINT: see the 'idle' behavior defined above for a template!
