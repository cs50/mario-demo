    ...
    this.behaviors = {
        ['idle'] = function(dt)
            ...
            if love.keyboard.isDown('left') then
                direction = 'left'
                -- TODO: set a velocity for moving left

            elseif love.keyboard.isDown('right') then
                direction = 'right'
                -- TODO: set a velocity for moving right

            else
                -- TODO: set a velocity for standing still
...
function Player:update(dt)
    ...
    -- TODO: move the player based on their horizontal velocity
    -- HINT: don't forget to take into consideration delta time!
