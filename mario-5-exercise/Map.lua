...
function Map:update(dt)
    ...
    -- TODO: lock the camera's X position to the player's position, but making
    -- sure it displays him in the middle of the screen
    -- HINT: make sure you're still doing bounds checking to prevent the camera
    -- from displaying out-of-bounds
    -- HINT: math.max and math.min are your friend, though this can still be
    -- accomplished with if-statements
