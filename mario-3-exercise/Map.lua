...
function Map:update(dt)
    -- TODO: test for left and right keyboard presses and update camera accordingly
    -- HINT: love.keyboard.isDown?
    -- HINT: we should probably exercise bounds checking so we don't render beyond the
    -- map; maybe math.max and math.min can help us out here?

    -- TODO: test for up and down keyboard presses and update camera accordingly
    -- HINT: love.keyboard.isDown?
    -- HINT: we should probably exercise bounds checking so we don't render beyond the
    -- map; maybe math.max and math.min can help us out here?
